...
class MLX90640 {
	...
	public static class Params{
		...
		double KsTa;
		double[] ksTo = new double[4];
		int[] ct = new int[4];
		double[] alpha = new double[768];
		int[] offset = new int[768];
		double[] kta = new double[768];
		double[] kv = new double[768];
		double[] cpAlpha = new double[2];
		int[] cpOffset = new int[2];
		double[] ilChessC = new double[3];
		int[] brokenPixels = new int[5];
		int[] outlierPixels = new int[5];
	}



	int ExtractParameters(int[] eeData, Params mlx90640)
	{
	...
	double GetVdd(int[] frameData, Params params)
	{
	    double vdd;
	    ...
	    resolutionCorrection = Math.pow(2, (double)params.resolutionEE) / Math.pow(2, (double)resolutionRAM);
	...
	double GetTa(int[] frameData, Params params)
	{
	    double ptat;
	    double ptatArt;
	    double vdd;
	    ...
	    ptatArt = (ptat / (ptat * params.alphaPTAT + ptatArt)) * Math.pow(2.0, 18.0);
	...
	int GetSubPageNumber(int[] frameData)
	{
	...
	void GetImage(int[] frameData, Params params, double[] result)
	{
	    double vdd;
	    double ta;
	    double gain;
	...
	void CalculateTo(int[] frameData, Params params, double emissivity, double tr, double[] result)
	{
	...
	//------------------------- To calculation -------------------------------------    
	    ...
	    for( int pixelNumber = 0; pixelNumber < 768; pixelNumber++)
	    {
	        ...
	        {    
	            ...
	            To = Math.sqrt(Math.sqrt(irData / (alphaCompensated * alphaCorrR[range] * (1 + params.ksTo[range] * (To - params.ct[range]))) + taTr)) - 273.15;
	...
	void ExtractVDDParameters(int[] eeData, Params mlx90640)
	{
	    int kVdd;
	    int vdd25;
	...
	void ExtractPTATParameters(int[] eeData, Params mlx90640)
	{
	    double KvPTAT;
	    double KtPTAT;
	    int vPTAT25;
	...
	void ExtractGainParameters(int[] eeData, Params mlx90640)
	{
	    int gainEE;
	...
	void ExtractTgcParameters(int[] eeData, Params mlx90640)
	{
	    double tgc;
	...
	void ExtractResolutionParameters(int[] eeData, Params mlx90640)
	{
	    int resolutionEE;
	...
	void ExtractKsTaParameters(int[] eeData, Params mlx90640)
	{
	    double KsTa;
	...
	void ExtractKsToParameters(int[] eeData, Params mlx90640)
	{
	    int KsToScale;
	   	int step;
	...
	void ExtractAlphaParameters(int[] eeData, Params mlx90640)
	{
	...
	void ExtractOffsetParameters(int[] eeData, Params mlx90640)
	{
	...
	void ExtractKtaPixelParameters(int[] eeData, Params mlx90640)
	{
	    int p = 0;
	    int[] KtaRC = new int[4];
	    int KtaRoCo;
	...
	void ExtractKvPixelParameters(int[] eeData, Params mlx90640)
	{
	    int p = 0;
	    int[] KvT = new int[4];
	    int KvRoCo;
	...
	void ExtractCPParameters(int[] eeData, Params mlx90640)
	{
	    double[] alphaSP = new double[2];
	    int[] offsetSP = new int[2];
	    double cpKv;
	    double cpKta;
	    int alphaScale;
	    int ktaScale1;
	...
	void ExtractCILCParameters(int[] eeData, Params mlx90640)
	{
	    double[] ilChessC = new double[3];
	    int calibrationModeEE;
	...
	int ExtractDeviatingPixels(int[] eeData, Params mlx90640)
	{
	    int pixCnt = 0;
	    int brokenPixCnt = 0;
	    int outlierPixCnt = 0;
	...
	//------------------------------------------------------------------------------
	 ...
	 int CheckAdjacentPixels(int pix1, int pix2)
	 {
	     int pixPosDif;
	 ...
	 int CheckEEPROMValid(int[] eeData)  
	 {
	     int deviceSelect;
